...
const skeletonSecondParagraphLines = [
  'w-11/12',
  'w-full',
  'w-8/12',
]
const skeletonCodeLines = [
  'w-7/12',
  'w-10/12',
  'w-9/12',
  'w-11/12',
]
const skeletonCommentLines = [
  'w-11/12',
  'w-8/12',
]
    ...
    >
      ...
      <header class="grid gap-6 pt-2">
        ...
        <div class="grid gap-5">
          <div class="grid max-w-5xl gap-3">
            ...
            <div class="h-14 w-10/12 rounded-xl bg-mist-50/10 sm:h-20 lg:h-24" />
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="h-11 w-20 rounded-xl border border-mist-50/10 bg-mist-50/6" />
          <div class="h-11 w-20 rounded-xl border border-mist-50/10 bg-mist-50/6" />
          <div class="h-11 w-36 rounded-xl border border-brass-200/25 bg-brass-200/10" />
        </div>
      </header>

      <div class="aspect-[16/9] w-full rounded-xl border border-mist-50/10 bg-[linear-gradient(135deg,rgba(255,249,238,0.08),rgba(255,249,238,0.025)_48%,rgba(240,201,120,0.08))]" />
      ...
      <section class="article-shell px-5 py-8 sm:px-8 sm:py-10 lg:px-12">
        <div class="article-body mx-auto">
          ...
          <div class="rounded-xl border-l-4 border-brass-300/55 bg-brass-200/8 px-5 py-4">
            <div class="grid gap-3">
          ...
          <div class="grid gap-3 rounded-xl border border-mist-50/10 bg-ink-950/80 p-5">
            <div
      ...
      <section class="grid gap-5">
        ...
        <div class="grid gap-3 rounded-xl bg-[#252525] p-4 shadow-[0_14px_36px_rgba(0,0,0,0.18)]">
